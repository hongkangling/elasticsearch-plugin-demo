...
public class LetterSegmenter implements ISegmenter {
	 ...
	 * @return
	 */
	private boolean processMixLetter(Context context) {
	 ...
	 * @return
	 */
	private boolean processEnglishLetter(Context context) {
		boolean needLock = false;
	 ...
	 * @return
	 */
	private boolean processArabicLetter(Context context) {
		boolean needLock = false;

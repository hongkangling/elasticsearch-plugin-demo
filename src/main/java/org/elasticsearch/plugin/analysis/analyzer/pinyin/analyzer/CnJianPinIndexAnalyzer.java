...
public class CnJianPinIndexAnalyzer extends Analyzer {
	...
	public static void main(String[] args) throws IOException {
		String[] items = new String[] { "中文英文", "motel168", "7天" };
		CnJianPinIndexAnalyzer analyzer = new CnJianPinIndexAnalyzer();
